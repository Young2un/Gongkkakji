      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="rounded-2xl border border-white/5 bg-card/40 backdrop-blur-md p-4 sm:p-6 flex flex-col justify-center items-center gap-4">
          ...
          <div className="flex gap-3 w-full justify-center">
            <a
              href={process.env.STREAMER_CHANNEL_ID ? `https://chzzk.naver.com/${process.env.STREAMER_CHANNEL_ID}` : 'https://chzzk.naver.com'}
              target="_blank"
              rel="noreferrer"
              className="flex h-12 w-12 items-center justify-center rounded-full bg-[#00FFA3]/10 text-[#00FFA3] hover:bg-[#00FFA3]/20 hover:scale-110 transition-all border border-[#00FFA3]/20"
              title="치지직"
            >
              <span className="font-black text-lg">C</span>
            </a>
            <a
              href="https://discord.com/invite/vTXuZ3mcDK"
              target="_blank"
              rel="noreferrer"
              className="flex h-12 w-12 items-center justify-center rounded-full bg-[#5865F2]/10 text-[#5865F2] hover:bg-[#5865F2]/20 hover:scale-110 transition-all border border-[#5865F2]/20"
              title="디스코드"
            ...
            <a
              href="https://www.youtube.com/@%EA%B9%80%EA%B3%B5%EC%9D%80%EC%9D%B4"
              target="_blank"
              rel="noreferrer"
              className="flex h-12 w-12 items-center justify-center rounded-full bg-[#FF0000]/10 text-[#FF0000] hover:bg-[#FF0000]/20 hover:scale-110 transition-all border border-[#FF0000]/20"
              title="유튜브"
              aria-label="유튜브 채널"
            >
              <Play className="h-5 w-5 fill-current" />
            </a>
            {/* 인스타 — 채널 생기면 href 채우고 주석 풀기
            <a href="#" target="_blank" rel="noreferrer" className="flex h-12 w-12 items-center justify-center rounded-full bg-[#E1306C]/10 text-[#E1306C] hover:bg-[#E1306C]/20 hover:scale-110 transition-all border border-[#E1306C]/20" title="인스타그램">
