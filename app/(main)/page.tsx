      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="rounded-2xl border border-white/5 bg-card/40 backdrop-blur-md p-4 sm:p-6 flex flex-col justify-center items-center gap-4">
          ...
          <div className="flex gap-3 w-full justify-center">
            ...
            {/* 유튜브/인스타 — 채널 생기면 href 채우고 주석 풀기
            <a href="#" target="_blank" rel="noreferrer" className="flex h-12 w-12 items-center justify-center rounded-full bg-[#FF0000]/10 text-[#FF0000] hover:bg-[#FF0000]/20 hover:scale-110 transition-all border border-[#FF0000]/20" title="유튜브">
